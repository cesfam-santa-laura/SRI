            ...
            <div class="row">
              <div class="col-md-12">
                <div class="panel panel-primary">
                  ...
                  <div class="panel-heading"> Datos del Nacimiento </div>
                  <div class="panel-body">
                    <form class="form-horizontal">

                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="#SaludMenta">Fecha</label>
                        <div class="col-sm-10">
              ...
              <div class="panel panel-primary " >
                ...
                <div class="panel-heading">
                  <h2>
                    ...
                    <label class="control-label">&nbsp;Editar/Agregar Información Paciente Salud Infantil</label>
                  </h2>
                </div>
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="panel with-nav-tabs ">
                                  ...
                                  <div class="form-group col-md-1">
                                    ...
                                    <div class="tab-pane fade" id="tab3primary">
                                      ...
                                      <div class="tab-pane fade" id="tab4primary">
                                        ...
                                        <div class="form-group col-md-2">
                                          <label class="control-label">DIALISIS</label>
                                          <br>
                                        ...
                                        <div class="form-group col-md-2">
                                          <label class="control-label ">FECHA DIALISIS</label>
                                          <br>
                        ...
                        <div class="modal-footer">
                          ...
                          <button type="button" class="btn btn-success"  name="btnProcesar" id="btnProcesar">Guardar Cambios</button>
