...
<div class="container-fluid"> 
   <div class="panel panel-primary " >
    <div class="panel-heading"> 
       <h2><span class="glyphicon glyphicon-list-alt"> </span><label class="control-label">&nbsp;LISTADO PACIENTES CRONICOS</label> </h2>
    </div>     
    </div>
    ...
    <h1><a class="btn btn-primary btn-social pull-right" href='../Info_Pacientes/Form.php'>
...
<div class="container-fluid"> 
            ...
            while ($data = mysqli_fetch_assoc($query)) {  
             ...
             <tr >
               ...
               <div>
                ...
                <i class='glyphicon glyphicon-edit'></i>   <i class='fa fa-user'></i>
				</button>
                ...
                <i  class='glyphicon glyphicon-folder-open'></i>   <i class='fa  fa-user-md'></i>
                          </a> 
  ...
  <?php 
	...
	require_once "../Modals/ModalEditarUsuario.php";
