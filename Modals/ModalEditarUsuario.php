 ...
 <div class="container-fluid"> 
   <div class="panel panel-primary " >
    <div class="panel-heading"> 
       <h2><span class="glyphicon glyphicon-pencil"> </span><label class="control-label">&nbsp;Editar Infrormación Personal Paciente Crónico</label> </h2>
    </div>     
    </div>
  <legend></legend>       
...
<div class="row">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <div class="input-group">
				        <input type="text" class="form-control" id="txtTelef" name="txtTelef"/><span class="input-group-addon"><span class="glyphicon glyphicon-phone"></span></span>
                       </div>  
				    </div>
      ...
      <div class="modal-footer">
        ...
        <button  class="btn btn-primary" type="button" class="btn btn-success left"  name="btnGuardarCambios" id="btnGuardarCambios">Guardar Cambios</button>
