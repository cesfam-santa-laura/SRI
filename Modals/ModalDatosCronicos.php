...
<form id="formDatosCronico" name="formDatosCronico"  role="form" method="post" action="" onsubmit="return validar(this);">           
  ...
  <div class="panel panel-primary " >
     <div class="panel-heading"> 
       <h2><span class="glyphicon glyphicon-pencil"> </span><label class="control-label">&nbsp;Editar/Agregar Información Paciente Crónico</label> </h2>
    </div> 
...
<div class="col-md-12">
 ...
 <div class="tab-pane fade" id="tab3primary">
      ...
      <div class="modal-footer">
        ...
        <button  class="btn btn-primary" type="button" class="btn btn-success left"  name="btnProcesar" id="btnProcesar">Guardar Cambios</button>
