...
?>
	 ...
	 <div class="alert alert-danger">  
      ...
      <h4 align="center"> <strong>!Error¡</strong> Debe Ingresar Un Rut para Validar </h4>
        </div>
...
<?php
	...
	$consulta = mysqli_query($con, "SELECT  * FROM db_usuarios u,  db_sector t  
 where u.bd_sect =t.sl_idSect
 AND  bd_rut = '$rut'")  or die('error: '.mysqli_error($con));
...
<div class="alert alert-warning" align='center'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>  
	 <h2>  <i class='icon glyphicon glyphicon-warning-sign'> </i> ¡Atento!</h2>
...
<div class="row">
                    ...
                    <div class="form-group col-md-2 ">
				        ...
				        <input type="date" class="form-control "  id="txtFechaNac" name="txtFechaNac" min="1900-01-01" max="2030-01-01" requerid required pattern="[0-9]{2}-[0-9]{2}-[0-9]{4}"><span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                       </div>  
				    </div>
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <div class="input-group">
				        <input type="text" class="form-control" id="txtTel" name="txtTel" required><span class="input-group-addon"><span class="glyphicon glyphicon-phone"></span></span>
                       </div>  
				    </div>
				...
				<div class="form-group col-md-2 ">
                    ...
                    <div class="form-group col-md-2 ">
						<label class="control-label ">FECHA ELECTRO</label>
                          <div class="input-group">
                            <input type="date"  placeholder="" id="txtFelectro" name="txtFelectro" class="form-control date-picker" data-date-format="dd-mm-yyyy"><span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                       </div>  
		           ...
		           <div class="form-group col-md-2">
                    ...
                    <div class="form-group col-md-2">
						...
						<select class="form-control" name="txtEstPap" id="txtEstPap">
                            ...
                            <option value="NO VIGENTE">NO VIGENTE</option></select>
				    </div>
                    ...
                    <div class="form-group col-md-2">
						<label class="control-label ">FECHA DIALISIS</label><br>
                           <div class="input-group col-xs-11">
                            <input type="date" class="form-control date-picker" data-date-format="dd-mm-yyyy" placeholder="" id="txtfdialisis" name="txtfdialisis"><span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                       </div>    
