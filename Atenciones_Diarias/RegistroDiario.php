...
<body>
 ...
 <div class="panel panel-primary " >
    <div class="panel-heading"> 
       <h2><span class="glyphicon glyphicon-book"> </span><label class="control-label">&nbsp;Consulta Registro Atenciones Diarias</label> </h2>
    </div>     
    </div>     
 ...
 <div class="panel-body">   
     ...
     <div class="form-group col-md-2 col-md-offset-0">
                        <label class="control-label">MEDICO</label><br>
