                            ...
                            <div class="navbar-login">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        ...
                                        <p class="text-left small"><strong>SECTOR - <?php echo $_SESSION['sector'];?></strong></p>
                                        <p class="text-left">
                        ...
                        <li>
                            <div class="navbar-login ">
                                <div class="row">
									 <div class="col-lg-12">
                                        <p>
                                            <button type="button" class="btn btn-info btn-block btn-default" data-toggle="modal" data-target="#logout"><span class="fa fa-lock " ></span><strong> Cambiar  Contraseña</strong></button>
                                        </p>
                                    </div>
                                    <div class="col-lg-12">
                                        <p>
                                            <button type="button" class="btn btn-danger btn-block btn-default" data-toggle="modal" data-target="#logout"><span class="glyphicon glyphicon-log-out" ></span><strong> Cerrar Sesion</strong></button>
                                        </p>
                                    </div>
                                </div>
                            </div>
