	...
	<div class="container-fluid">
		...
		<form id="form1" name="form1"  role="form" method="post" action="" onsubmit="return validar(this);">
					...
					<div class="row">
						...
						<div class="form-group col-md-2 col-md-offset-0">
							...
							<div class="input-group col-xs-10">
								<input type="date" autocomplete="off" class="form-control " id="txtFechaNac" name="txtFechaNac" >
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-success left"  name="btnProcesar2" id="btnProcesar2">Guardar Cambios</button>
